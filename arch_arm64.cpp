...
public:
	...
	virtual vector<uint32_t> GetAllIntrinsics() override
	{
		return vector<uint32_t> {
			...
			ARM64_INTRIN_PACIA, ARM64_INTRIN_PACIBSP, ARM64_INTRIN_PRFM, ARM64_INTRIN_PSBCSYNC, ARM64_INTRIN_SEV,
			ARM64_INTRIN_SEVL, ARM64_INTRIN_WFE, ARM64_INTRIN_WFI, ARM64_INTRIN_YIELD
		};
	}
